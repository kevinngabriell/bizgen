...
erp_dashboard: {
  ...
  recent_vendor_bills: "Recent Vendor Bills",
  recent_sales_quotations: "Recent Sales Quotations",
  recent_purchase_requisitions: "Recent Purchase Requisitions",
  view_all: "View All →",
  ...
  vendor_bills_pending: "vendor bills pending",
},
finance_module: {
  ...
  outstanding_payables: "Outstanding Payables",
  cashflow_balance: "Cashflow Balance",
  accounts_receivable_billing: "Accounts Receivable & Billing",
  create_invoice: "Create Invoice",
  customer_invoices: "Customer Invoices",
  pending: "Pending",
  unpaid_receivables: "Unpaid Receivables",
  overdue: "Overdue",
  ...
  accounts_payable_vendor_bills: "Accounts Payable & Vendor Bills",
  add_vendor_bill: "Add Vendor Bill",
  ...
  recent_vendor_bills: "Recent Vendor Bills",
  no_vendor_bills: "No vendor bills yet",
  view_all_payables: "View All Payables",
  cashflow_ledger_overview: "Cashflow & Ledger Overview",
  cashflow_ledger_desc: "Cash In / Cash Out summary and general ledger mapping will appear here.",
  cashflow_ledger_next: "Next step: integrate with Job Costing & Shipment Profit reports.",
  operational_income_expenses: "Operational Income & Expenses",
  add_income: "Add Income",
  add_expense: "Add Expense",
  total_income: "Total Income",
  this_month: "This Month",
  total_expenses: "Total Expenses",
  net_operating_balance: "Net Operating Balance",
  auto_calculated: "Auto Calculated",
  view_income_expense_ledger: "View Income & Expense Ledger",
  due: "Due",
},
finance_see_all: {
  finance: "Finance",
  ...
  supplier: "Supplier",
  bill_date: "Bill Date",
  income_ledger_coming_soon: "Income & Ledger view coming soon.",
  no_records_found: "No records found.",
  search_placeholder: "Search by number, supplier, or customer...",
...
finance_invoice: {
  title_create: "Create Sales Invoice",
  title_view: "Sales Invoice",
  subtitle: "Select a customer to view their unpaid sales orders, then choose a payment method",
  invoice_details: "Invoice Details",
  invoice_no: "Invoice No.",
  invoice_date: "Invoice Date",
  form_no: "Form No.",
  ...
  currency: "Currency",
  exchange_rate: "Exchange Rate (to IDR)",
  payment_term: "Payment Term / Incoterm",
  due_date: "Due Date",
  notes_remarks: "Notes / Remarks",
  sales_orders: "Sales Orders",
  unpaid_sales_orders_for: "Unpaid sales orders for",
  select_customer_first: "Select a customer above to see their unpaid sales orders",
  loading_so: "Loading unpaid sales orders…",
  no_so_found: "No unpaid sales orders found",
  no_so_found_desc: "All sales orders for this customer have been paid.",
  so_number: "Sales Order No.",
  so_date: "Order Date",
  so_action: "Action",
  so_selected: "Selected",
  select_so: "Select",
  invoice_items: "Invoice Items",
  items_from_so: "Items are loaded from the selected sales order",
  no_items_loaded: "No items loaded",
  select_so_first: "Select a sales order above to load its items.",
  ...
  payment_method: "Payment Method",
  payment_method_desc: "Choose whether this invoice is paid in full or in installments (cicilan)",
  full_payment: "Full Payment",
  installment: "Installment",
  full_payment_desc: "Customer pays the entire invoice amount at once.",
  due_date_label: "Due date:",
  total_amount: "Total Amount",
  no_installments: "No installments yet. Click \"Add Installment\" to set up the payment schedule.",
  ...
  mark_paid: "Mark Paid",
  paid_date: "Paid Date",
  term_description: "Notes / Term Description",
  paid: "Paid",
  scheduled: "Scheduled",
  invoice_grand_total: "Invoice Grand Total",
  total_scheduled: "Total Scheduled",
  must_match_grand_total: "must match grand total",
  total_received: "Total Received",
  outstanding_balance: "Outstanding Balance",
  payment_information: "Payment Information",
  payment_info_desc: "Bank account, payment method and cheque details",
  receiving_bank: "Receiving Bank Account",
  cheque_no: "Cheque No.",
  cheque_date: "Cheque Date",
  cheque_amount: "Cheque Amount",
  shipping_logistics: "Shipping & Logistics",
  shipping_logistics_desc: "Port details, vessel/flight info and shipment timeline for B2B export/import",
  port_loading: "Port of Loading (Origin)",
  ...
  supporting_documents_desc: "Attach Commercial Invoice, Packing List, B/L, Certificate of Origin, etc.",
  drag_drop_upload: "Drag & drop or click to upload documents",
...
finance_vendor_bill: {
  title_create: "Create Vendor Bill",
  title_view: "Vendor Bill",
  subtitle: "Select a supplier to view their unpaid purchase orders, then choose a payment method",
  ...
  no_supplier_selected_desc: "Select a supplier first to load their unpaid purchase orders.",
  currency: "Currency",
  exchange_rate: "Exchange Rate (to IDR)",
  payment_term: "Payment Term / Incoterm",
  notes_remarks: "Notes / Remarks",
  purchase_orders: "Purchase Orders",
  unpaid_po_for: "Unpaid purchase orders for",
  unpaid_po_for_suffix: "(local & import)",
  select_supplier_first: "Select a supplier above to see their unpaid purchase orders",
  loading_po: "Loading unpaid purchase orders…",
  no_po_found: "No unpaid purchase orders found",
  no_po_found_desc: "All purchase orders for this supplier have been billed.",
  po_number: "PO Number",
  po_date: "PO Date",
  po_type: "Type",
  po_action: "Action",
  ...
  items_from_po: "Items are loaded from the selected purchase order",
  no_items_loaded: "No items loaded",
  select_po_first: "Select a purchase order above to load its items.",
  item_description: "Item / Description",
  qty: "Qty",
  uom: "UOM",
  unit_price: "Unit Price",
  ...
  grand_total_idr: "Grand Total (IDR)",
  payment_method: "Payment Method",
  payment_method_desc: "Choose whether this bill is paid in full or in installments (cicilan)",
  full_payment: "Full Payment",
  installment: "Installment",
  full_payment_desc: "Bill is paid to the supplier in a single payment.",
  due_date_label: "Due date:",
  total_amount: "Total Amount",
  no_installments: "No installments yet. Click \"Add Installment\" to set up the payment schedule.",
  add_installment: "Add Installment",
  ...
  total_scheduled: "Total Scheduled",
  must_match_bill_total: "must match bill grand total",
  total_paid: "Total Paid",
  outstanding_balance: "Outstanding Balance",
  shipping_logistics: "Shipping & Logistics",
  shipping_logistics_desc: "Port details, vessel/flight info and shipment timeline",
  port_loading: "Port of Loading (Origin)",
  port_discharge: "Port of Discharge (Destination)",
  vessel_flight_no: "Vessel / Flight No.",
  bl_awb_number: "B/L or AWB Number",
